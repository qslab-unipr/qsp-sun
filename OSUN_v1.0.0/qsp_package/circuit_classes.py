# This module contains all the classes used to generate the desired quantum circuit in the range m=2n,
# according to arXiv:2108.06150. In particular, there is a class for each stage of the circuit associated
